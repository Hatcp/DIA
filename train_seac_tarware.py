...
def parse_args():
    """Parse command line arguments for SEAC training and evaluation."""
    parser = argparse.ArgumentParser(description='Train and evaluate SEAC on TA-RWARE environment')
...
def setup_experiment(args):
    ...
    if args.exp_name is None:
        ...
        args.exp_name = f"{args.env_name}_seac_{timestamp}"
...
def main():
    """Main function to run SEAC training or evaluation."""
    args = parse_args()
    ...
    # Create EqualizedSEAC agent
    print("Initializing EqualizedSEAC agent...")
    agent = EqualizedSEAC(
        env=env,
        gamma=args.gamma,
        lr=args.lr,
    ...
    # Train the agents
    if args.train:
        print(f"\nTraining EqualizedSEAC on {args.env_name} for {args.n_episodes} episodes...")
